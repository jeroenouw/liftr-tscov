...
export function getTsConfigFilePath(project: string): any {
...
function statAsync(file: string): Promise<fs.Stats | undefined> {
...
function globAsync(pattern: string, ignore: string | string[], cwd?: string): Promise<string[]> {
